...
use Formy\Tests\Forms\UnicornHeadWithChoiceForm;
...
class ChoiceFieldTest extends TestCase
{
    ...
    public function canAttachChildToTheObject()
    {
        ...
        $headForm = UnicornHeadWithChoiceForm::create($unicornHead);
    ...
    public function canAttachMultipleChildsToTheObjectAtOnce()
    {
        ...
        /** @var UnicornHeadWithChoiceForm $form */
        $form = UnicornHeadWithChoiceForm::create($unicornHead);
